    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (connection.type.toLowerCase()) {
            case 'teamwork': {
                ...
                try {
                    teamworkResponse = yield services_1.teamworkService.putEstimate(services_1.encryptionService.decrypt(connection.token), connection.externalData.baseUrl, taskId, hours);
                }
                catch (error) {
...
exports.putEstimate = putEstimate;
//# sourceMappingURL=put-estimate.js.map